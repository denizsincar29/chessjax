...
export const I18N = {
  ru: {
    ...
    boardIntro: "Шахматная доска. Нажмите Enter, чтобы открыть.",
    help: [
  ...
  en: {
    ...
    boardIntro: "Chessboard. Press Enter to open.",
    help: [
  ...
  de: {
    ...
    boardIntro: "Schachbrett. Enter drücken, um es zu öffnen.",
    help: [
  ...
  tr: {
    ...
    boardIntro: "Satranç tahtası. Açmak için Enter'a basın.",
    help: [
